...
public class Constantes {
	...
	public static final String MENSAJE_NO_EXISTE_REGISTROS = "No existen registros.";
	public static final String MENSAJE_NO_AUTORIZADO = "Usuario o contraseña incorrecto.";
}